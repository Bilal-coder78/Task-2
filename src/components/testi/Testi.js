...
function Testi() {
  ...
  return (
    <div id='testi'>
      <div className="testi-headings">
        <h3>Testimonials</h3>
        <h1>What They Say</h1>
      </div>
      {activetesti === "testi-box" && (<div className="testi-box">
      ...
      {activetesti === "testi-box2" && (<div className="testi-box">
        <div className="testi-left">
          <h4 className='svg'><FaQuoteLeft /></h4>
          <p>
      ...
      {activetesti === "testi-box3" && (<div className="testi-box">
        <div className="testi-left">
          <h4 className='svg'><FaQuoteLeft /></h4>
          <p>
